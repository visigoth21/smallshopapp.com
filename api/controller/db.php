...
class DB {
	...
	public static function connectWriteDB() {
		if(self::$writeDBConnection === null) {
				self::$writeDBConnection = new PDO('mysql:host=localhost;dbname=visigoth_smallshop;charset=utf8', 'visigoth_smallshop', '$4Nothing&Chicks40');
	...
	public static function connectReadDB() {
		if(self::$readDBConnection === null) {
				self::$readDBConnection = new PDO('mysql:host=localhost;dbname=visigoth_smallshop;charset=utf8', 'visigoth_smallshop', '$4Nothing&Chicks40');
